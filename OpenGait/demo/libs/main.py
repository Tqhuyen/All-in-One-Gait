...
human_data = {
    "id": "01",
    "name": "Tran Quang Huyen"
}

def dir_prepare(human_data):
    data_ref_dir = "/home/tqhuyen/All-in-One-Gait/data_reference/"
...
def main():
    ...
    gallery_video_path = "./demo/output/InputVideos/huyen_train.mp4"
